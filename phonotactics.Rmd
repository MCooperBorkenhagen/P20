...
## Nonwords generated from manipulating codas
...
words_with_manipulated_coda = purrr::list_rbind(nonword_list)

words_with_manipulated_coda = words_with_manipulated_coda %>% 
  filter(word_not_word == "nonword") %>% 
  select(Word = target_word_for_nonword, Pron_clean = target_pron_for_nonword, nonword_from_manipulated_coda, word_with_same_sound_in_final_pos, probability = P, rank)


words_with_manipulated_coda %>% 
  write_csv("~/Desktop/nonwords_with_manipulated_coda.csv")
```
...
words_with_manipulated_onsets = words_with_manipulated_onsets %>% 
  filter(word_not_word == "nonword") %>% 
  select(Word = target_word_for_nonword, Pron_clean = target_pron_for_nonword, nonword_from_manipulated_onset, word_with_same_sound_in_second_pos, probability = P, rank)
